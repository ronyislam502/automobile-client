...
const Footer = () => {
  return (
    <div className="mx-auto bg-slate-300 lg:px-[70px] lg:py-10 py-5 px-5 bg-primary-foreground/10 mt-[70px] text-slate-950 flex lg:flex-row flex-col justify-between gap-x-10 gap-y-5">
